...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="TELEOPREDCLOSE")
public class TeleOpRedClose extends CommandOpMode {
    ...
    public void initialize(){
        ...
        follower.setStartingPose(new Pose(84 ,84));
...
//        robot.turret.AutoAim(RED_BASKET_X,RED_BASKET_Y);
        super.run();
